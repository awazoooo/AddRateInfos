(function (){
    ...
    */
    ...
    const constantTable = [
        ...
        {title: "Chelly spLash♪♪", diff: 3, constant: 0.0},
        ...
        {title: "今ぞ♡崇め奉れ☆オマエらよ！！～姫の秘メタル渇望～", diff: 3, constant: 13.4},
        ...
        {title: "妖狐仙楽踏", diff: 3, constant: 0.0},
        ...
        {title: "ドーナツホール", diff: 3, constant: 0.0},
        {title: "アンハッピーリフレイン", diff: 3, constant: 0.0},
        {title: "ゴーカ！ごーかい！？ファントムシーフ！", diff: 3, constant: 13.1},
        {title: "ようこそジャパリパークへ", diff: 4, constant: 0.0},
        {title: "星屑ユートピア", diff: 3, constant: 13.0},
        {title: "Paqqin", diff: 3, constant: 0.0},
        {title: "Rising Hope", diff: 3, constant: 13.0},
        {title: "天火明命", diff: 3, constant: 13.0},
        {title: "DAYBREAK FRONTLINE", diff: 3, constant: 13.0},
        {title: "UTAKATA", diff: 3, constant: 0.0},
        {title: "God knows...", diff: 3, constant: 0.0},
        {title: "時の冒険者", diff: 3, constant: 13.0},
        {title: "sweet little sister", diff: 3, constant: 0.0},
