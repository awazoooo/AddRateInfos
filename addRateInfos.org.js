...
const newMusicTable = [
    ...
    {title: 'Heart Cooking Recipe', diff: 3, constant: 12.9},
    ...
    { title: "Girls Talk!!", diff: 3, constant: 12.8 },
{title: 'Change Our MIRAI！ (Our 7 Lights)', diff: 3, constant: 12.8},
{title: '猫祭り', diff: 3, constant: 12.8},
{title: 'INSIDE IDENTITY', diff: 3, constant: 12.8},
{title: 'ヒトリボッチサテライト', diff: 2, constant: 12.7},
{title: '愛言葉Ⅲ', diff: 3, constant: 12.7},
    { title: "The Everlasting Guilty Crown", diff: 3, constant: 12.7 },
    { title: "Hello, Morning", diff: 3, constant: 12.7 },
    {title: '白い雪のプリンセスは', diff: 3, constant: 12.7},
    {title: 'Crow Song', diff: 3, constant: 12.7},
...
{title: 'My Soul,Your Beats!', diff: 3, constant: 12.5},
